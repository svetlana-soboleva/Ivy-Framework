...
public enum LegendTypes { Line, PlainLine, Square, Rect, Circle, Cross, Diamond, Star, Triangle, Wye, None }
public enum Scales { Auto, Linear, Pow, Sqrt, Log, Identity, Time, Band, Point, Ordinal, Quantile, Quantize, Utc, Sequential, Threshold }
public enum StackOffsetTypes { Expand, None, Wiggle, Silhouette }