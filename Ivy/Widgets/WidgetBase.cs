...
public abstract record WidgetBase<T> : AbstractWidget where T : WidgetBase<T>
{
    ...
    /// </summary>
    /// <param name="children">The children of the widget.</param>
    ...
    /// <summary>
    /// The test ID of the widget. 
    /// Used for finding the widget in the DOM for testing.
    /// </summary>
...
public static class WidgetBaseExtensions
{
    ...
    /// <returns>The widget with the width set.</returns>
    ...
    /// <returns>The widget with the size set.</returns>
    ...
    /// <returns>The widget with the visibility set.</returns>
